...
Author: Vantricks
Version: 3.1
URI: https://github.com/hacktricks2023/
*/
...
ytpSetI.innerHTML+=`<b style='font-size:18px' >Vantricks EuTube PRO Settings</b>
...
</svg> by Vantricks Team</div>
<br><br>
<div style="font-size:13px;"><b style="font-weight:bold">Disclaimer</b>: This is an unofficial Youtube Mod Vantricks , all the logos and brands are property of Google LLC.<br>
You can get the source code at <a href="#" onclick="Android.oplink('https://github.com/hacktricks2023/EuTubePro')" > https://github.com/hacktricks2023/EuTube Pro</a>
<br><br><center>
<a href="#" onclick="Android.oplink('https://github.com/hacktricks2023/EuTube Pro/issues')" >Report Bugs</a>
</center></div>`;
